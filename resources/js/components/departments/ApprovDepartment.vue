        ...
        >
            <template v-slot:content>
                <div class="flex flex-col p-2">
                    <h3
                        v-if="!$refs.command_maker.command_sent"
                        class="font-extrabold text-lg my-3 text-vN"
                    >
                        Voulez vous annuler la commande ?
                    </h3>

                    <h3 v-else class="font-extrabold text-lg my-3 text-vN">
                        Si vous quittez maintenant, vous allez annuler la
                        commande que vous venez d'envoyer.
                    </h3>
            ...
            if (!confirm) {
                if (
                    ...
                    (this.$refs.command_maker.commands.length > 0 ||
                        this.$refs.command_maker.command_sent)
                ) {
