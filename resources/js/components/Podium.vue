<template>
    <div
        :class="
            'relative h-48 flex items-center bg-gradient-to-t rounded-3xl py-7 w-full px-4 text-vN mb-10 border-[#EEEEF2] ' +
            bg
        "
    >
...
export default {
    ...
    computed: {
        bg: function () {
            if (this.position == 1) {
                return "from-[#FFBC3E82] to-[#FFBC3E28]";
            } else if (this.position == 2) {
                return "from-[#0B34343B] via-[#0B343418] to-[#0B34341F]";
            } else {
                return "from-[#FFBC3E2F] via-[#FFBC3E28] to-[#FFBC3E66]";
            }
        },
    },
};
