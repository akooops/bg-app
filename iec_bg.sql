...
(12, '2023-04-25 18:30:44', '2023-04-25 18:30:44', 'Pull à col bâteau', 2399, 3399, 0, 198671, 198700, 1.00, 'Fabriqué à partir d’un mélange doux de coton et de lin, ce pull vous offrira un confort optimal tout en vous tenant bien au chaud. Son col bateau élégant apporte une touche de sophistication à votre tenue. \nCe pull s\'adapte à tous les styles et toutes les occasions. Sa coupe ajustée mettra en valeur votre silhouette tout en vous offrant une liberté de mouvement totale.\nC’est la pièce ultime qui complètera votre collection de vêtements d’hiver.', 1.50, 500.00, '/assets/pullcol.webp', 0, 19.87, 500, 1),
